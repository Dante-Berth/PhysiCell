...
response = requests.get(
    "https://api.github.com/repos/PhysiCell-Tools/PhysiCell-Studio/releases/latest"
)
...
remote_url = (
    "https://github.com/PhysiCell-Tools/PhysiCell-Studio/archive/refs/tags/"
    + vnum
    + ".zip"
)
...
latest_studio_dir = (
    "PhysiCell-Studio-" + vnum[1:]
)  # need to drop the 'v' as first character
shutil.move(latest_studio_dir, "studio")
print(f"renamed '{latest_studio_dir}' to 'studio'")

print("\n-- Sample commands to run the Studio:")
print(
    "python studio/bin/studio.py     # attempts to load config/PhysiCell_settings.xml"
)
